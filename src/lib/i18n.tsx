...
const dict = {
  ru: {
    ...
    hero: {
      ...
      widgetCaption: "Косметический бренд, 120 чел. Производство карточек для маркетплейсов.",
      widgetLabel: "ИНТЕРАКТИВ · ПЕРЕТАЩИТЕ",
      before: "СЕЙЧАС",
      after: "С AI",
      metrics: [
        { label: "Время на карточку", from: 45, to: 12, suffix: " мин", deltaInverted: true },
        { label: "Ошибки в описаниях", from: 9.5, to: 1.8, suffix: "%", deltaInverted: true },
        { label: "Конверсия карточки", from: 3.1, to: 4.6, suffix: "%", deltaInverted: false },
        { label: "Карточек/день", from: 12, to: 40, suffix: "", deltaInverted: false },
      ],
      flowBefore: ["Новый SKU", "Копирайтер", "SEO вручную", "Дизайн", "Загрузка"],
      flowAfter: ["Новый SKU", "AI-генерация", "Авто-SEO", "Проверка", "Загрузка"],
      captionBefore:
        "Новый товар — копирайтер вручную пишет описание, подбирает ключевые слова, отдельно адаптирует под Wildberries, Ozon и Золотое Яблоко. 10–14 карточек в день. Ошибки в составе и характеристиках находят после публикации, в отзывах.",
      captionAfter:
        "AI-агент генерирует описание, характеристики и SEO из данных товара и брифа, адаптирует под каждый маркетплейс и язык. Контент-менеджер только проверяет тон и факты. 35–45 карточек в день. Ошибки — на входе.",
      stack: "STACK: GPT-4.1 + Claude · LangGraph · Postgres · n8n · WB/Ozon API",
      disclaimer: "Иллюстративный сценарий на основе отраслевых бенчмарков по автоматизации контента в beauty/FMCG. Точные цифры — после аудита вашего бизнеса.",
    },
    problem: {
      label: "01 / ПРОБЛЕМА",
