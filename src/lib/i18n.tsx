  ...
  ru: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Откуда цифры в калькуляторе?", a: "Усреднённые показатели из McKinsey State of AI 2024, Deloitte AI Adoption Survey и BCG GenAI Value Report. Автоматизируемая доля 62% — нижняя граница оптимистичных оценок: 55–70% по бенчмаркам. Реальные цифры калибруются в первый же аудит." },
