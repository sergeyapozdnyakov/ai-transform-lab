...
const dict = {
  ru: {
    ...
    expert: {
      ...
      bio: [
        "Я начал писать код в конце 90-х. За 25 лет прошёл путь от джуниора до ИТ-директора — в том числе в Estée Lauder и Panasonic, а последние годы — как CIO международной премиальной парфюмерно-косметической сети Zielinski & Rozen (50 магазинов, 5 стран). Видел циклы технологий: веб-революцию, мобильную волну, облака, big data — и сейчас AI.",
    ...
    cases: {
      ...
      items: [
        { industry: "Бьюти-ритейл", metric: "60%", unit: "обращений закрывает бот", ctx: "AI-ассистент поддержки консультантов сети: товары, остатки, процедуры — без эскалации на бэк-офис. Реальный проект в Estée Lauder.", before: "6 мин/ответ", after: "30 сек/ответ" },
        { industry: "Финансы / бэк-офис", metric: "−70%", unit: "времени на рутину", ctx: "Центр RPA-автоматизации на UIPath и Power Automate: роботы закрывают повторяющиеся операции в финансах и отчётности. Опыт построения CoE в Estée Lauder. Работает в любой отрасли.", before: "8 ч/день", after: "2.4 ч/день" },
        { industry: "Склад / логистика", metric: "−58%", unit: "ошибки комплектации", ctx: "WMS: адресное хранение, партии и сроки годности, станция сборки со сверкой по штрихкоду. Внедрял на 6 складах в Zielinski & Rozen.", before: "4.1%", after: "1.7%" },
      ],
    },
    roi: {
      ...
      recommendations: [
        {
          ...
          solution: "Бот закрывает типовые вопросы консультантов и клиентов (товары, остатки, процедуры, доставка) без эскалации. Внедрял в сети Estée Lauder.",
        ...
        {
          title: "RPA рутинных операций",
          solution: "Роботы UiPath / Power Automate закрывают повторяющиеся операции в финансах, отчётности и документообороте. Опыт построения центра RPA.",
        ...
        {
          title: "Sell-out аналитика и прогноз",
          solution: "Автосбор продаж, дашборды в реальном времени и прогноз спроса по SKU. Снижает out-of-stock и неликвиды. Проект в рознице из 50 магазинов.",
          integrations: "1С · Power BI · data lake",
          timeline: "5–7 недель",
          effect: "−24% out-of-stock",
          category: "CORE",
        },
        {
          title: "PIM/MDM и мастер-данные",
          solution: "Единая карточка товара: спецификации, медиа, сертификаты, маркировка, рынки. Чистые данные ускоряют листинг и снижают ошибки. Опыт SAP Master Data и PIM/MDM.",
          integrations: "1С · PIM · ГИС МТ «Честный знак»",
          timeline: "6–8 недель",
          effect: "качество данных + быстрый листинг",
          category: "CORE",
        },
      ],
      bottleneckReasons: [
  ...
  en: {
    ...
    hero: {
      ...
      disclaimer: "Based on a sell-out analytics and forecasting project in a 50-store retail chain. Exact numbers — after auditing your business.",
    },
    problem: {
      label: "01 / PROBLEM",
    ...
    expert: {
      ...
      bio: [
        "I started writing code in the late 90s. Over 25 years I went from junior engineer to IT director — including roles at Estée Lauder and Panasonic, and most recently as CIO of Zielinski & Rozen, an international premium perfumery & cosmetics retail chain (50 stores, 5 countries). I've watched the cycles: the web revolution, the mobile wave, cloud, big data — and now AI.",
      ...
      recommendations: [
        {
          ...
          solution: "A bot resolves typical questions from consultants and customers (products, stock, procedures, delivery) without escalation. Rolled out inside the Estée Lauder chain.",
        ...
        },
        {
          ...
          solution: "UiPath / Power Automate bots close repetitive operations in finance, reporting and document flow. Hands-on experience building an RPA Center of Excellence.",
        ...
        },
        {
          ...
          solution: "Auto-collected sales, real-time dashboards and SKU-level demand forecasting. Reduces out-of-stocks and dead stock. Delivered for a 50-store retail chain.",
        ...
        },
        {
          ...
          solution: "A single product record: specs, media, certificates, regulatory marking, target markets. Clean data speeds up listing and reduces errors. Built on SAP Master Data and PIM/MDM experience.",
