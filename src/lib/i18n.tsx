...
const dict = {
  ru: {
    ...
    widget2: {
      ...
      title: "Из брифа — в карточку товара. За секунды.",
      sub: "Реальный пример: бриф на новый продукт от бренд-менеджера. Состав, свойства, объём, целевая аудитория — разрозненно, в свободной форме.",
      tabs: ["Документ", "Анализ", "Результат"],
      docMeta: "BRIEF-2026/318 · PDF · 1 стр.",
      statusIdle: "○ ОЖИДАНИЕ",
      statusParsing: "● АНАЛИЗ",
      statusDone: "● ИЗВЛЕЧЕНО",
      caption:
        "Извлечение и структурирование данных из брифа — 8 секунд. Точность 96% на структурированных полях. Поле review_required — места, где AI намеренно просит проверки человеком (например, маркетинговые claims, требующие юридической вычитки), а не угадывает.",
      reviewLabel: "REVIEW REQUIRED",
      reviewItem: "claims[1].efficacy — требует подтверждения",
      bracketLabels: [
        "product_info",
        "ingredients",
        "claims × 3",
